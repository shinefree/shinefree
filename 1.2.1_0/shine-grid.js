...
$('html').on('click','.comment-image',function(e){
	...
	$('.shine-expand .large-image').css("background-image", "url(" + $(this).data("image") + ")" );

	$('.shine-expand .large-image').zoom({url: $(this).data("image"), on: 'click'});
...
$('html').on('click','.comment-youtube',function(e){
...
$('html').on('click','.comment-html5', function(e){
...
$('html').on('click','.comment-gfycat', function(e){
	...
	$('.shine-expand .large-html5').html("<video controls preload='auto' autoplay='autoplay' muted='muted' loop='loop' webkit-playsinline ><source src='//fat.gfycat.com/" + $(this).data("video") + ".mp4' type='video/mp4' /><source src='//giant.gfycat.com/" + $(this).data("video") + ".mp4' type='video/mp4' /><source src='//zippy.gfycat.com/" + $(this).data("video") + ".mp4' type='video/mp4' /></video>");
...
$('html').on('click','.comment-album', function(e){
	...
	getCommentAlbumImages( $(this).data("album") );
