...
$('html').not('.shine-list-classic').on('click','.comment-image',function(e){

	$(this).parents(".shine-expand").find(".large-area").html('<div class="large-image" style="background-image:url(' + $(this).data("image") + ');"></div>');

	$(this).parents(".shine-expand").find(".large-image").zoom({url: $(this).data("image"), on: 'click'});


});

$('html').not('.shine-list-classic').on('click','.comment-youtube',function(e){

	$(this).parents(".shine-expand").find(".large-area").html('<div class="large-youtube"><iframe frameborder="0" allowfullscreen src="' + $(this).data("video") + '" /></div>');

});

$('html').not('.shine-list-classic').on('click','.comment-html5', function(e){

	$(this).parents(".shine-expand").find(".large-area").html('<div class="large-html5"><video controls preload="auto" autoplay="autoplay" muted="muted" loop="loop" webkit-playsinline ><source src="' + $(this).data("video") + '" type="video/mp4" /></video></div>');

});

$('html').not('.shine-list-classic').on('click','.comment-gfycat', function(e){

	$(this).parents(".shine-expand").find(".large-area").html("<div class='large-html5'><video controls preload='auto' autoplay='autoplay' muted='muted' loop='loop' webkit-playsinline ><source src='//fat.gfycat.com/" + $(this).data("video") + ".mp4' type='video/mp4' /><source src='//giant.gfycat.com/" + $(this).data("video") + ".mp4' type='video/mp4' /><source src='//zippy.gfycat.com/" + $(this).data("video") + ".mp4' type='video/mp4' /></video></div>");
...
$('html').not('.shine-list-classic').on('click','.comment-album', function(e){

	getCommentAlbumImages( $(this).data("album"), $(this).parents(".shine-expand") );
...
$('html').not('.shine-list-classic').on('click','.comment-image, .comment-youtube, .comment-html5, .comment-gfycat, .comment-album', function(e){
